...
function Training() {
  return (
    <>
    <div className='traincontent1' data-aos="fade-down">
    </div>
    <div className='container-fluid p-3'>
      <h1 className='text-center fs-3' data-aos="fade-down">Our certified personal trainers create the perfect programs to help<br/> you reach your goals, designed 100% around you.</h1>
    </div>
    <div className='container'><hr/></div>
    <div className='traincontent2 container-fluid bg-light p-3'>
      <div className='row'>
        <div className='col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center' data-aos="fade-right">
        ...
        <div className='col-lg-6 col-md-12 col-sm-12 p-5' data-aos="fade-left">
