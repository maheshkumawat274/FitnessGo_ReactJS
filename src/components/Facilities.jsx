...
function Facilities(x) {
  return (
    ...
    <div className='facibtn contaier-fluid text-center p-5' data-aos="fade-down">
    ...
    <div className='container-fluid'>
      <div className='row'>
        ...
        <div className='col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center align-items-center' data-aos="fade-right">
    ...
    <div className='container-fluid'>
      <div className='row'>
        <div className='col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center align-items-center' data-aos="zoom-in">
    ...
    <div className='container-fluid'>
      <div className='row'>
        <div className='col-lg-6 col-md-12 col-sm-12' data-aos="right">
        ...
        <div className='col-lg-6 col-md-12 col-sm-12 d-flex justify-content-center align-items-center'data-aos="fade-left">
