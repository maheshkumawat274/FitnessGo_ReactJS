        ...
        <div className="container py-5">
          <div className="row">
            <div className="col-lg-6 col-md-12 mb-4 d-flex flex-column justify-content-center align-items-center">
              <h1 className="fw-bold text-center mb-4">THE BEST RECOVERY</h1>
            ...
            <div className="col-lg-6 col-md-12 text-center mb-4">
              ...
              <p className="fs-5 pt-3">The perfect place to knock out those athletic workouts, take content, and use the TANK.</p>
            </div>
          </div>
        </div>
